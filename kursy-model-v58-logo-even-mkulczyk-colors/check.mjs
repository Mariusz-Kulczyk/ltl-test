...
function sidebarLoadPlanner(){return `<a class="sidebar-tool sidebar-loadplanner sidebar-brand-loadplanner" href="loadplanner.html" data-local-loadplanner aria-label="Load Planner"><span class="sidebar-tool-icon">↗</span><div><b>Nasz Load Planner</b><small>plik z tej paczki ZIP</small></div></a>`}
function sidebarBrand(){return `<div class="lang-public-label sidebar-lang-top">Wersja językowa</div>${langButtons()}<div class="brand sidebar-main-brand"><div class="mark">PFE</div><div>Padmain Freight Exchange<small>M.KULCZYK</small></div></div>${sidebarLoadPlanner()}`}
