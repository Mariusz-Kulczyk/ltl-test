...
function sidebarBottom(logged=true){return `<div class="sidebar-bottom-stack"><a class="sidebar-tool sidebar-loadplanner" href="loadplanner.html" data-local-loadplanner aria-label="Load Planner"><span class="sidebar-tool-icon">↗</span><div><b>Nasz Load Planner</b><small>plik z tej paczki ZIP</small></div></a><a class="sidebar-partner-link" href="https://motohouse-tsl.com" target="_blank" rel="noopener noreferrer" aria-label="MotoHouse"><strong>${esc(ui('currentlyAt'))}</strong><img class="sidebar-partner-logo" src="https://mkulczyk.pl/motohouse-logo-2.svg" alt="MotoHouse"></a>${logged?`<button data-action="logout" class="btn dark logout">${esc(ui('logout'))}</button>`:''}</div>`}
